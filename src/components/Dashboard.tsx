...
const notes = [
  ...
  },
  {
    id: 2,
    title: 'Ideas',
    content: 'New feature suggestions...',
    date: '2024-03-13',
  },
  {
    id: 3,
    title: 'Tasks',
    content: 'Priority items for next sprint...',
    date: '2024-03-12',
  },
  {
    id: 4,
    title: 'Research',
    content: 'Market analysis findings...',
    date: '2024-03-11',
  },
  {
    id: 5,
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const noteRef = ref(database, 'notes'); // Reference to the "todos" node in Firebase
    ...
    const unsubscribe = onValue(noteRef, (snapshot) => {
      ...
      if (data) {
        ...
        setNotes([]); // If no data, set an empty array
      }
    });
            ...
            >
              {notes.map((note) => (
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm mb-2">{note.noteBody}</p>
